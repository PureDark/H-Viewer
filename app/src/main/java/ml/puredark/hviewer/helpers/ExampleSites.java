...
//                Site.FLAG_NO_RATING + "|" + Site.FLAG_JS_NEEDED_ALL + "|" + Site.FLAG_WATERFALL_AS_LIST + "|" + Site.FLAG_JS_SCROLL));
        ...
        galleryRule = new Rule();
//        galleryRule.cover = new Selector("div.cover img", "attr", "src", null, null);
//        galleryRule.description = new Selector("div.stats", "html", null, null, null);
//        galleryRule.tags = new Selector("div.tags>.tag", "html", null, null, null);
//        galleryRule.uploader = new Selector("div.details>div.detail:nth-child(3)>div.data", "html", null, null, null);
        galleryRule.datetime = new Selector("div.details>div.detail:nth-child(5)>div.data", "html", null, null, null);
//        galleryRule.category = new Selector("div.details", "html", null, "Views.*?>([\\d,]+).*?Favorites.*?<span.*?>(\\d+)", "✦$1    ❤$2");
        ...
        sites.add(new Site(69, "H-Anime",
                ...
                indexRule, galleryRule, null, null,
                Site.FLAG_NO_RATING + "|" + Site.FLAG_POST_INDEX + "|" + Site.FLAG_JS_NEEDED_GALLERY));
        categories = new ArrayList<>();

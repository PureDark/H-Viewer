...
public class LocalCollectionAdapter
    ...
    private ExpandableDataProvider<FavGroup, LocalCollection> mProvider;
    private RecyclerViewExpandableItemManager mExpandableItemManager;
    private OnItemClickListener mItemClickListener;
    private OnItemEventListener onItemEventListener;
    private CollectionTagAdapter.OnItemClickListener mTagClickListener;

    public LocalCollectionAdapter(Context context, ExpandableDataProvider<FavGroup, LocalCollection> mProvider) {
    ...
    public GroupViewHolder onCreateGroupViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_fav_group, parent, false);
    ...
    public void onBindGroupViewHolder(GroupViewHolder holder, final int groupPosition, int viewType) {
        if (groupPosition == getGroupCount() - 1) {
            ...
            FavGroup group = mProvider.getGroupItem(groupPosition);
    ...
    public ExpandableDataProvider<FavGroup, LocalCollection> getDataProvider() {
        return mProvider;
    }

    public void setDataProvider(ExpandableDataProvider<FavGroup, LocalCollection> mProvider) {
        this.mProvider = mProvider;
    }
